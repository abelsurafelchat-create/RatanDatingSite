      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-2xl font-bold">IndiDate</h3>
            </div>
            <p className="text-gray-400 text-sm mb-4">
              India's most trusted dating and marriage platform. Find your perfect match today!
            </p>
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 bg-gray-700 hover:bg-primary-600 rounded-full flex items-center justify-center transition">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><a href="#" className="hover:text-primary-500 transition">Success Stories</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><a href="#" className="hover:text-primary-500 transition">Community Guidelines</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400 text-sm">
              <li className="flex items-center gap-2">
                ...
                <span>support@indidate.com</span>
              </li>
              <li className="flex items-center gap-2">
            ...
            <div className="mt-4 flex items-center gap-2 text-sm">
              ...
              <span className="text-gray-400">100% Secure & Private</span>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © {currentYear} IndiDate. All rights reserved. Made with <Heart className="w-4 h-4 inline text-pink-500" fill="currentColor" /> in India
          </p>
          <div className="flex gap-6 text-sm text-gray-400">
            ...
            <a href="#" className="hover:text-primary-500 transition">Cookies</a>
          </div>
        </div>
      </div>
    </footer>
