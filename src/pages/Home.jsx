          ...
          {currentIndex < recommendations.length ? (
            ...
            <div className="relative h-[500px] sm:h-[600px]">
              ...
              {currentIndex + 1 < recommendations.length && (
                <div className="absolute inset-0 bg-white rounded-3xl shadow-xl overflow-hidden transform scale-95 opacity-50 pointer-events-none">
                  <img
                    src={recommendations[currentIndex + 1].photos?.[0] || recommendations[currentIndex + 1].profile_photo}
                    alt="Next"
              ...
              <AnimatePresence>
                <motion.div
                  ...
                  className="absolute inset-0 bg-white rounded-3xl shadow-2xl overflow-hidden cursor-grab active:cursor-grabbing z-10"
                >
                  {/* Photo Gallery */}
                          ...
                          <>
                            ...
                            <button
                              ...
                              className={`absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-white/80 hover:bg-white rounded-full shadow-lg transition ${
                                currentPhotoIndex >= userPhotos.length - 1 ? 'opacity-50 cursor-not-allowed' : ''
                              }`}
                            >
            ...
            {/* Action Buttons - Outside card container */}
